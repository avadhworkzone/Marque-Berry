      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset(
                widget.data.groupType == GroupStatus.private ? ic_lock : ic_globe_antarctic,
                height: 16,
                width: 16,
                fit: BoxFit.cover,
              ...
              TextButton(
                onPressed: () {
                  if (widget.data.isGroupAdmin.validate() && widget.data.groupType == GroupStatus.privateGroup) {
                  ...
                  } else if (widget.data.groupType == GroupStatus.public || widget.data.isGroupMember.validate()) {
                    GroupMemberScreen(
                      creatorId: widget.data.groupCreatedById.validate(),
                      groupId: widget.data.id.validate(),
                      isAdmin: widget.data.isGroupAdmin.validate(),
