...
class ForumDetailScreen extends StatefulWidget {
  final int forumId;
  final String type;
  final bool isFromSubcription;

  const ForumDetailScreen({required this.forumId, required this.type, this.isFromSubcription = false});
                    ...
                    if (val == 1) {
                      ifNotTester(() {
                        ...
                        subscribeForum(forumId: widget.forumId).then((value) {
                          if (widget.isFromSubcription) isUpdate = true;
                        }).catchError((e) {
                          log(e.toString());
                        });
                      });
                  ...
                  isFetched
                      ? SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ProfileHeaderComponent(avatarUrl: forum.image.validate()),
                              16.height,
