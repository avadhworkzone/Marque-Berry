                                ...
                                return Column(
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        cachedImage(cartItem.images!.first.src.validate(), height: 60, width: 60, fit: BoxFit.cover).cornerRadiusWithClipRRect(defaultAppButtonRadius),
                                        16.width,
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                if (!appStore.isLoading)
                                  ifNotTester(() async {
                                    await Future.forEach<CartItemModel>(cart!.items.validate(), (element) async {
                                      ...
                                      CheckoutScreen(cartDetails: cart!).launch(context);
                                    });
                                  });
                              },
                              elevation: 0,
