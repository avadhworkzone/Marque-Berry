                      ...
                      return Stack(
                        children: [
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              cachedImage(review.reviewerAvatarUrls!.full, height: 40, width: 40, fit: BoxFit.cover).cornerRadiusWithClipRRect(25),
                              16.width,
                              Column(
                                children: [
                          ...
                          if (review.reviewer == appStore.loginFullName)
                            Positioned(
                              child: Text('${language.editReview}', style: secondaryTextStyle(color: context.primaryColor, size: 12)).onTap(() {
                                showInDialog(
                                  context,
