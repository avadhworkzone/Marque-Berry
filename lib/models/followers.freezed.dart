...
abstract class $FollowersCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? username, String? fullName, String? image});
}
...
class _$_Followers extends _Followers {
  ...
  @override
  String toString() {
    return 'Followers(id: $id, username: $username, fullName: $fullName, image: $image)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, username, fullName, image);
