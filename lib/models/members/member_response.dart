...
class MemberResponse {
  ...
  MemberResponse({this.links, this.avatarUrls, this.friendshipStatus, this.friendshipStatusSlug, this.id, this.link, this.mentionName, this.name, this.userLogin, this.isUserVerified});
