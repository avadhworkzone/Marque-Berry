...
//                   controller: PageController(initialPage: homeController.tabCurrentIndex),
//                   onPageChanged: (value) async {
//                     homeController.tabChange(value);
//                     homeController.tabScrollController.animateTo(
//                         value > 2
//                             ? homeController
...
//                         selectedCategoryDataList[value - 2].name,
//                       );
//                       categoryFeedViewModel.pageNumberIndex = 0;
//                       categoryFeedViewModel.isPageLoading = false;
//                       await categoryFeedViewModel.categoryTrending(
//                         selectedCategoryDataList[value - 2].name.toString(),
//                       );
//                     }
//                   },
...
//                         } else if (categoryFeedViewModel
//                             .categoryApiResponse.status ==
//                             Status.ERROR ||
...
//
//   void updateTabController(int page){
