...
class _ProfileState extends State<Profile> {
  final List<ImagesModel> profileImageList = [
    ImagesModel(
      image:
  ...
  final List<ImagesModel> mentionsImageList = [
    ImagesModel(
        image:
    ...
    ImagesModel(
        image:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTq8NX8c_P2Iz5Ib_xQv0fTzjLtrQLl1eAMj1ZpBBAvWRON8r16QN8wdt5wsA5UtWbuE0A&usqp=CAU'),
  ];
      ...
      child: Scaffold(
        ...
        body: GetBuilder<ProfileViewModel>(builder: (profileViewModel) {
          return GetBuilder<ProfileController>(
            initState: (_) {
              getUserProfile(profileViewModel);
                            ...
                            children: [
                              ...
                              profileController.tabIndex == 0
                                  ...
                                  : Container(
                                      ...
                                      child: GridView.builder(
                                        shrinkWrap: true,
                                        itemCount: mentionsImageList.length,
                                        physics: NeverScrollableScrollPhysics(),
                                        gridDelegate:
                                            SliverGridDelegateWithFixedCrossAxisCount(
                                          crossAxisCount: 3,
  ...
  getUserProfile(ProfileViewModel profileViewModel) async {
...
class ProfileController extends GetxController {
  ...
  Future<void> updateCoverImage(cropPath) async {
