          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      if (authViewModel.memeCategoryApiResponse.status ==
                        ...
                        return InkWell(
                          onTap: interestController.selectedIndex.length < 3
                              ? () {
                                  logs("1");
                          ...
                          child: Stack(
                            children: [
                              ...
                              if ((interestController.tempIndex.contains(
                                      memeResponse.data?[index].title)) ==
                                  true)
                                Container(
                                  height: 2.5.h,
                ...
                SizeConfig.sH2,
                Center(
                  child: interestController.selectedIndex.length == 3
                      ? CustomBtn(
                          onTap: () async {
                            interestController.setPreference();
